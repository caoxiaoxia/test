...
sender = "2362464781@qq.com" # 发送人的邮件
recevises = ["2431320433@qq.com"] # 接收人
...
att1 = MIMEText(open('F:\测试技术开发\python\interface\讲师评价系统的讲师查询测试报告.html', 'rb').read(), 'base64', 'utf-8')
att1["Content-Type"] = 'application/octet-stream'
# 这里的filename可以任意写，写什么名字，邮件中显示什么名字
att1["Content-Disposition"] = 'attachment;filename="jiangshi.html"'
message.attach(att1)
